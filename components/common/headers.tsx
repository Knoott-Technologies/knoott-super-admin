...
export const PageMiniHeaderCollapsible = ({
  title,
  description,
  children,
  id,
  ...
  return (
    <div
      id={id}
      className={cn(
        "w-full h-fit items-start justify-between flex mb-5 lg:mb-7 gap-5 group",
        className
      )}
    >
      <div className="flex flex-col gap-y-1 items-start justify-start">
        <span className="flex gap-x-1 items-center">
          ...
          <h1
            className={cn(
              "text-lg xl:text-xl tracking-tight font-semibold group-hover:underline underline-offset-2",
              libre.className
            )}
          >
            {title}
