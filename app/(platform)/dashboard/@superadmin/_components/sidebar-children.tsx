        ...
        <SidebarMenu>
          {group.items.map((item, i) => (
            <SidebarMenuItem key={i}>
              ...
              {(item.count && (
                <SidebarMenuBadge className="bg-destructive/10 ring-1 ring-destructive/50 text-[11px] text-destructive peer-data-[active=true]/menu-button:text-destructive peer-hover/menu-button:text-destructive">
                  {item.count}
                </SidebarMenuBadge>
              )) ||
                (item.count === 0 && (
