      ...
      <section className="w-full h-fit items-start justify-start flex flex-col gap-y-5 lg:gap-y-7">
        ...
        <div className="w-full border rounded-lg">
          ...
          <div className="border-t px-4 py-3 grid grid-cols-6 gap-4">
            ...
            <Skeleton className="h-5 w-24" /> {/* Contacto */}
            <Skeleton className="h-5 w-28" /> {/* Ventas */}
          ...
          {Array.from({ length: 8 }).map((_, index) => (
            ...
            >
              ...
              <div className="space-y-1">
                <Skeleton className="h-5 w-24 bg-green-50/30" />{" "}
                {/* Ventas totales */}
                <Skeleton className="h-4 w-20" /> {/* Pendientes */}
              </div>
